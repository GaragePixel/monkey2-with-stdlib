...
Class MyWindow Extends Window
	...
	Method OnCreateWindow() Override
		...
		_scene=New Scene
		_scene.ClearColor = New oldColor( 0.2, 0.6, 1.0 ) 
		...
		'create ground
		Local groundBox:=New std.geom.Boxf( -100,-1,-100,100,0,100 )
		Local groundMaterial:=New PbrMaterial( oldColor.Lime )
		_ground=Model.CreateBox( groundBox,1,1,1,groundMaterial )
		_ground.CastsShadow=False
		
		'create donut
		Local donutMaterial:=New PbrMaterial( oldColor.Red, 0.05, 0.2 )
