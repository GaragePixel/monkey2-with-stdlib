Namespace SimpleVideoPlayerExample
...
Using stdlib..
Using sdk_mojo..
'Using sdklib_mojo.medias.simplevideo..
...
Class AppWindow Extends Window
	...
	Method New(title:String, width:Int, height:Int)
		...
		Print "verbose off! "
		'stdlib.plugins.libc.system("clear")
		'stdlib.plugins.libc.system("exit")
		''Print ESC+ESC
		Print "verbose off! "
...
Function Main()
	New AppInstance
	New AppWindow("simplevideo example", 960, 540)
	App.Run()
End
