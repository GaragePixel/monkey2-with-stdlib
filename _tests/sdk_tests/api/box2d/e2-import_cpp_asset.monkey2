...
'#Import "<stdlib>"' <- iDkP: we must comment that to avoid circular dependency
#Import "<sdk>"
#Import "<sdk_mojo>"

'choose one of the files to import c++ asset source

#Import "cpp_from_rube/rubegoldberg.h" 	'iDkP: from https://www.youtube.com/watch?v=Cf4gy4gmsn8 (take a look! )
'#Import "cpp_from_rube/deums.h"		'iDkP: not implemented
'#Import "cpp_from_rube/stress.h"		'iDkP: not implemented
'#Import "cpp_from_rube/stress2.h"		'iDkP: not implemented



'Using stdlib.. '<- iDkP: we must comment that to avoid circular dependency
Using sdk.. 
Using sdk_mojo..

Using stdlib.math.. 'iDkP: Next, we need stdlib but only the mathematic part
