...
Class MyWindow Extends Window
	...
	Method New( title:String="Simple mojo app",width:Int=640,height:Int=480,flags:WindowFlags=WindowFlags.Resizable )
		...
		'data=DataBuffer.Load( "asset::15337-1.mp4" )
...
'		vidclip=vidman.createVideoClip( AssetsDir()+"konqi.ogv" )
		...
		image=New Image( vidclip.getWidth(),vidclip.getHeight(),PixelFormat.RGB24,TextureFlags.FilterMipmap )
		'image=New Image( vidclip.getWidth(),vidclip.getHeight(),PixelFormat.RGB24,TextureFlags.Dynamic │ TextureFlags.FilterMipmap )
